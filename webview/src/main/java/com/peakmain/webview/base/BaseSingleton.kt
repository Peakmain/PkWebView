package com.peakmain.webview.base
...
internal abstract class BaseEmptySingleton<out T> {
    @Volatile
...
internal abstract class BaseOneSingleton<in P, out T> {
    @Volatile
    private var sInstance: T? = null
...
internal abstract class BaseTwoSingleton<in P1, in P2, out T> {
    @Volatile
    private var sInstance: T? = null
